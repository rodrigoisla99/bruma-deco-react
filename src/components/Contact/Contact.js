...
const Contact = () => {
    ...
    <>
        ...
        <Form className="form-contact">
            ...
            <div className="enviar-contacto">
              <Button className="send-contact" variant="primary" type="submit">
                Enviar
            </Button> 
            </div>
        </Form>
    ...
    <Accordion className="accordion" defaultActiveKey="0">
      ...
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body>
        <strong>Los envíos se realizan martes y jueves.</strong> En Bariloche se concuerda un punto de entrega y para otra parte del país, se hace a través de correo privado previa coordinacion con el comprador.
        </Accordion.Body>
      </Accordion.Item>
